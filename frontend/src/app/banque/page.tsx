        ...
        {sousThematiques.map((sous, idx) => (
          ...
          >
            ...
            <div className="md:w-1/2 w-full flex flex-col justify-center text-left">
              <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white mb-4">{sous.titre}</h2>
              <p className="text-base md:text-lg text-slate-600 dark:text-slate-300 mb-2 leading-relaxed">{sous.description}</p>
              <Link to="/contact">
