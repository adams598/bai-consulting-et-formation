...
async function testDebug() {
  console.log("🔍 Debug des APIs en erreur\n");
  ...
  // Test détaillé de l'activité récente
  console.log("🔍 Test détaillé de l'activité récente...");
  try {
  ...
  // Test détaillé de la performance des formations
  console.log("\n🔍 Test détaillé de la performance des formations...");
  try {
