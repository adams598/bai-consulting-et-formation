...
async function createRecentActivities() {
  try {
    console.log("🔄 Création d'activités récentes avec des dates correctes...");
    ...
    // Créer des activités avec des dates récentes (dernières 7 jours de 2024)
    const now = new Date();
    ...
    for (let i = 0; i < formations.length; i++) {
      ...
      if (!existingAssignment) {
        ...
        // Mettre à jour la date d'assignation pour qu'elle soit récente
    ...
    console.log("✅ Activités récentes créées avec succès !");
