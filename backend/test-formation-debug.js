...
async function testFormationDebug() {
  console.log("🔍 Debug de l'API de performance des formations\n");
  ...
  console.log("🔍 Test de l'activité récente...");
  try {
...
testFormationDebug().catch(console.error);
